...
export const {
  ...
  SHORTCUTS_JUMP_PREVIOUS_PAGE,
  SHORTCUTS_JUMP_NEXT_PAGE,
  SHORTCUTS_SCROLL_LEFT,
  SHORTCUTS_SCROLL_RIGHT,
  SHORTCUTS_SCROLL_UP,
  SHORTCUTS_SCROLL_DOWN,
  ANNOUNCE_SCROLLED_LEFT,
  ANNOUNCE_SCROLLED_RIGHT,
  ANNOUNCE_SCROLLED_UP,
  ANNOUNCE_SCROLLED_DOWN,
  ANNOUNCE_CANT_SCROLL_FURTHER,
  ...
  WORKSPACE_SEARCH_FIND_NEXT,
  WORKSPACE_SEARCH_FIND_PREVIOUS,
  WORKSPACE_SEARCH_CLOSE,
  WORKSPACE_SEARCH_NO_MATCHES,
