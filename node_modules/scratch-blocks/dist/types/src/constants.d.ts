 ...
 */
declare const SCALAR_VARIABLE_TYPE = "";
 ...
 */
declare const BROADCAST_MESSAGE_VARIABLE_TYPE = "broadcast_msg";
 ...
 */
declare const LIST_VARIABLE_TYPE = "list";
export { LIST_VARIABLE_TYPE };
declare const PROCEDURES_DEFINITION_BLOCK_TYPE = "procedures_definition";
export { PROCEDURES_DEFINITION_BLOCK_TYPE };
declare const PROCEDURES_DECLARATION_BLOCK_TYPE = "procedures_declaration";
export { PROCEDURES_DECLARATION_BLOCK_TYPE };
/**
 * The type of all procedure prototype blocks.
 */
declare const PROCEDURES_PROTOTYPE_BLOCK_TYPE = "procedures_prototype";
export { PROCEDURES_PROTOTYPE_BLOCK_TYPE };
/**
 * The type of all procedure call blocks.
 */
declare const PROCEDURES_CALL_BLOCK_TYPE = "procedures_call";
export { PROCEDURES_CALL_BLOCK_TYPE };
declare const OUTPUT_SHAPE_HEXAGONAL = 1;
export { OUTPUT_SHAPE_HEXAGONAL };
declare const OUTPUT_SHAPE_ROUND = 2;
 ...
 */
declare const NEW_BROADCAST_MESSAGE_ID = "NEW_BROADCAST_MESSAGE_ID";
 ...
 */
export declare enum ScratchBlocksTheme {
    CLASSIC = "classic",
